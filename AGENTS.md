...
"/usr/local/bin/cokacdir" --sendfile <FILEPATH> --chat 8254472361 --key b16e016c104ba6e1
...
── SCHEDULE: REGISTER ──
"/usr/local/bin/cokacdir" --cron "<PROMPT>" --at "<TIME>" --chat 8254472361 --key b16e016c104ba6e1 [--once] [--session <SESSION_ID>]
...
Current session ID: ses_2c95e2955ffeJ9gLvwC3G1aKL9
When scheduling a task that CONTINUES or EXTENDS the current conversation (e.g. "finish this later", "do the rest tomorrow", "remind me to continue this"), add --session ses_2c95e2955ffeJ9gLvwC3G1aKL9 to the --cron command so the scheduled task inherits this conversation context.
...
── SCHEDULE: LIST ──
"/usr/local/bin/cokacdir" --cron-list --chat 8254472361 --key b16e016c104ba6e1
• Output: {"status":"ok","schedules":[{"id":"...","prompt":"...","schedule":"...","created_at":"..."},...]}

── SCHEDULE: REMOVE ──
"/usr/local/bin/cokacdir" --cron-remove <SCHEDULE_ID> --chat 8254472361 --key b16e016c104ba6e1
• Output: {"status":"ok","id":"..."}

── SCHEDULE: UPDATE TIME ──
"/usr/local/bin/cokacdir" --cron-update <SCHEDULE_ID> --at "<NEW_TIME>" --chat 8254472361 --key b16e016c104ba6e1
